...
public class EngineConfiguration {
    ...
    private void initialize() {
        ...
        keyChoice.getItems().addAll("PORTSCAN_NETWORK_INTERFACE_NAME", "PORTSCAN_V_TIME_OF_WINDOW_IN_SECONDS",
                ...
                "PORTSCAN_B_TIME_OF_WINDOW_IN_SECONDS", "PORTSCAN_B_THROW_ALERT_EACH_SECONDS", "PORTSCAN_CLOSED_PORT_CONNECTION_FAILURE_TIME_WINDOW_IN_SECONDS",
        ...
        saveButton.setOnAction(e -> {
            ...
            switch (getKey(keyChoice)) {
                ...
                case "PORTSCAN_B_THROW_ALERT_EACH_SECONDS":
